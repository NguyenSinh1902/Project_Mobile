...
import { getAccommodationsByHotel } from '../../../services/AccommodationService';
import { addFavorite, removeFavorite, getFavorites } from '../../../services/FavoriteService';

const HotelList = ({ customer }) => {
  ...
  useEffect(() => {
    const fetchAccommodations = async () => {
      try {
        const data = await getAccommodationsByHotel();
...
const styles = StyleSheet.create({
  ...
  card: { width: 180, marginRight: 15, marginTop: 10, borderRadius: 10, backgroundColor: '#fff' },
